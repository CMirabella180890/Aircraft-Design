# -*- coding: utf-8 -*-
"""
Created on Mon Apr  5 07:11:07 2021
...
# ============================================================================
# ============================================================================
JSONFileName1 = "engine_input.json"
...
# ============================================================================
# THRUST-TO-WEIGHT RATIO FOR A GENERIC TURBOPROP ENGINE 
# ============================================================================     
fig1  = plt.figure()
...
pp1.close()
# ============================================================================
# POWER-TO-WEIGHT RATIO FOR A GENERIC TURBOPROP ENGINE      
# ============================================================================ 
...
# ============================================================================
# ============================================================================
JSONFileName2 = "aircraft_input.json"
...
my_aircraft1 = initial_sizing(AR, rho1, Vmax, Vmin, maxWS, nMAX, CDmin, CDTO,\
                              maxROC, g, mu, V_liftoff, CLTO, Sg, V_design,\
                              V_climb, eta_prop)
...
my_aircraft3 = initial_sizing(AR, rhoSC, Vmax, Vmin, maxWS, nMAX, CDmin, CDTO,\
                              ...
                              V_climb, eta_prop)    
# ============================================================================ 
# MAXIMUM LIFT COEFFICIENT AS A FUNCTION OF WING LOADING
# ============================================================================
V_STALL = np.linspace(knots2feetperseconds(95),knots2feetperseconds(115),5)
Max_Lift_Coeff = maximum_lift_coefficient(rho1, V_STALL, maxWS)
# ============================================================================
# NON-NORMALIZED THRUST-TO-WEIGHT RATIO FOR A REGIONAL TURBOPROP
# ============================================================================
...
plt.title(r'Constraints diagram')                          # Title to the axes.
plt.xlim(0, 60)
# plt.grid(True, linestyle='-.')
plt.show()
pp3.savefig(fig3)
...
# ============================================================================
# ============================================================================
# NON-NORMALIZED POWER-TO-WEIGHT CONVERSION FOR A REGIONAL TURBOPROP   
# ============================================================================ 
# ============================================================================
fig4, ax1 = plt.subplots()
#color = 'tab:red'
ax1.set_xlabel(r'Wing loading - $\frac{W}{S} \,\, [lb/ft^2]$')
ax1.set_ylabel(r'Power-to-weight ratio - $\frac{P}{W}$')
ax1.plot(my_aircraft1.ws, my_aircraft1.PWturn*Pow_ratio[0],\
         label=r"$\frac{P}{W}$ - Constant g turn - SL",
         linestyle="solid")
ax1.plot(my_aircraft2.ws, my_aircraft2.PWturn*Pow_ratio[-1],\
         label=r"$\frac{P}{W}$ - Constant g turn - $h_{\tiny \textup{max}}$",
         linestyle="solid")
ax1.plot(my_aircraft1.ws, my_aircraft1.PWclimb*Pow_ratio[0],\
         label=r"$\frac{P}{W}$ - Selected max climb - SL",
         linestyle="dashed")
ax1.plot(my_aircraft2.ws, my_aircraft2.PWclimb*Pow_ratio[-1],\
         label=r"$\frac{P}{W}$ - Selected max climb - $h_{\tiny \textup{max}}$",
         linestyle="dashed")
ax1.plot(my_aircraft1.ws, my_aircraft1.PWTO*Pow_ratio[0],\
         label=r"$\frac{P}{W} \,\, [hp/lb]$ - Selected Takeoff",
         linestyle="solid")  
ax1.plot(my_aircraft2.ws, my_aircraft2.PWCS*Pow_ratio[-1],\
         label=r"$\frac{P}{W} \,\, [hp/lb]$ - Selected Cruise speed",
         linestyle="dashdot")    
ax1.plot(my_aircraft3.ws, my_aircraft3.PWCS*Pow_ratio[-1],\
         label=r"$\frac{P}{W} \,\, [hp/lb]$ - Selected Service Ceiling",
         linestyle="dotted")
ax1.legend(loc="upper right", prop={"size" : 5})
ax1.grid(True, linestyle='-.')
ax1.set_ylim((0, 0.45))
...
plt.title(r'Normalized Constraints diagram')  # Title to the axes.
plt.xlim(0, 60)
# plt.grid(True, linestyle='-.')
plt.show()
pp4.savefig(fig4)
